function [ desired_state ] = trajectory_generator(t, ~, map, path)
...
% for t = 1:0.05:tmax 
        ...
        times = allequations(:,8);
        tmax = max(allequations(:,8));
...
%             end
            Cx = allequations(equationindex,1:6);
            ...
            Cy = allequations(equationindex+1,1:6);
            ...
            Cz = allequations(equationindex+2,1:6);
